                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mt-3">
                                        @if($lims_product_data->mini_shop_featured )
                                            <input type="checkbox" name="mini_shop_featured" value="1" checked>
                                        @else
                                            <input type="checkbox" name="mini_shop_featured" value="0" >
                                        @endif
                                        <label>Mini-Shop</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mt-3">
                                        @if($lims_product_data->best_sale_featured )
                                            <input type="checkbox" name="best_sale_featured" value="1" checked>
                                        @else
                                            <input type="checkbox" name="best_sale_featured" value="0" >
                                        @endif
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                               ...
                                               // dd($images);
                                                ...
                                                <tr>
                                                    <td><button type="button" class="btn btn-sm"><i class="fa fa-trash"></i></button></td>
                                                    <td>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Product Details(en)</label>
                                        <textarea name="product_details" class="form-control" rows="5">{{str_replace('@', '"', $lims_product_data->product_details)}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Product Details(ar)</label>
                                        <textarea name="product_details" class="form-control" rows="5">{{str_replace('@', '"', $lims_product_data->product_details_ar)}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="ingredients" class="form-control" rows="5">{{str_replace('@', '"', $lims_product_data->ingredients)}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Ingredients(ar)</label>
                                        <textarea name="ingredients_ar" class="form-control" rows="5">{{str_replace('@', '"', $lims_product_data->ingredients_ar)}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="how_to_use_ar" class="form-control" rows="5">{{str_replace('@', '"', $lims_product_data->how_to_use)}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>How TO Use(ar)</label>
                                        <textarea name="how_to_use_ar" class="form-control" rows="5">{{str_replace('@', '"', $lims_product_data->how_to_use_ar)}}</textarea>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        ...
                                                        ?>
                                                        @if($product_warehouse)
                                                            <input type="number" name="diff_qty[]" class="form-control" value="{{$product_warehouse->alert_qty}}">
                                                        @else
                                                            <input type="number" name="diff_qty[]" class="form-control">
                                                        @endif
                                                    </td>
                                                </tr>
                                                @endforeach
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        @if($lims_product_data->starting_date == null)
                                        <div id="start_date" class="col-md-4">
                                            <div class="form-group">
                                                <label>{{trans('file.Promotion Starts')}}</label>
                                                <input type="text" name="starting_date" value="" id="starting_date" class="form-control" />
                                            </div>
                                        </div>
                                        @else
                                           <div id="start_date" class="col-md-4">
                                        ...
                                        @endif
                                         ...
                                         @if($lims_product_data->last_date == null)
                                        <div id="last_date" class="col-md-4">
                                            <div class="form-group">
                                                 <?php
                                                    $date=date_create("30-12-2030");
                                                    $date=date_format($date,"d-m-Y");
                                                    //dd($date);
                                                    ?>
                                                <label>{{trans('file.Promotion Ends')}}</label>
                                                <input type="text" name="last_date" value="{{$date}}" id="ending_date" class="form-control" />
                                            </div>
                                        </div>
                                        @else
                                          <div id="last_date" class="col-md-4">

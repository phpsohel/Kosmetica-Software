                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_ar" class="form-control" id="name" aria-describedby="name" required>
                                        <span class="validation-msg" id="name-error"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><strong>Barcode Symbology *</strong> </label>
                                        <div class="input-group">
                                ...
                                <div id="unit" class="col-md-12">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-4">
                                                <div class="form-group">
                                                    <label><strong>Purchase Unit</strong> </label>
                                                    <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><strong>Tax Method</strong> </label> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.Exclusive: Poduct price = Actual product price + Tax. Inclusive: Actual product price = Product price - Tax')}}"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mt-3">
                                        <input type="checkbox" name="mini_shop_featured" value="1">&nbsp;
                                        <label>Mini-Shop</label>
                                        <p class="italic">This featured product will be displayed in Mini-Shop</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mt-3">
                                        <input type="checkbox" name="best_sale_featured" value="1">&nbsp;
                                        <label>Best Sale</label>
                                        <p class="italic">This Featured product will be displayed in Best Seller</p>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><strong>Product Image</strong> </label> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.You can upload multiple image. Only .jpeg, .jpg, .png, .gif file can be uploaded. First image will be base image.')}}"></i>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_details_ar" class="form-control" rows="3"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="ingredients_ar" class="form-control" rows="3"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="how_to_use" class="form-control" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>How To Use(ar)</label>
                                        <textarea name="how_to_use_ar" class="form-control" rows="3"></textarea>
                                    </div>
                                </div>
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" name="diff_price[]" class="form-control"></td>
                                                     <td><input type="number" name="diff_qty[]" class="form-control"></td>
                                                </tr>
                                                @endforeach
                                            </thead>
                                            <tbody>

               ...
               <br>
                <ul class="nav nav-tabs a" role="tablist">
                  ...
                  <li class="nav-item" >
                   ...
                   <li class="nav-item" >
                    <a class="nav-link" href="#lot-detail" role="tab" data-toggle="tab">Lot Wise Purchase Qty</a>
                  </li>
                  <li class="nav-item" >
                ...
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane fade show active" id="product-detail">
                       ...
                       @if($detail->price)
                        <div style="padding: 10px 20px;">
                       		<strong>Price:</strong>  {{ $detail->price }} BDT
                       </div>
                       @endif

                      @if($detail->promotion_price)
                          <div style="padding: 10px 20px;">
                              <strong> Promotional price:</strong>  {{ $detail->promotion_price }} BDT
                          </div>
                      @endif
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="purchase-detail">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="lot-detail">
                      <div class="table-responsive"><br>

...
<section>
     ...
     <div class="container-fluid">
        <div class="card">
            ...
            {!! Form::open(['route' => 'product.warehousesearch', 'method' => 'post']) !!}
            <div class="row">
                <div class="col-md-8">
                ...
                <table id="" class="table" style="width: 100%">
                    ...
                    <tbody>
                        @foreach($result as $key=>$val)
                           @php
                             $data =DB::table('categories')->where('id',$val->category_id)->select('name')->first();
                              $product_image = explode(",", $val->image);
                              $product_image = htmlspecialchars($product_image[0]);
                            @endphp
                        <tr>
                            <td>{{$key+1}}</td>
                           <td>
                           <img  src="{{url('public/images/product/'.$product_image)}}" style="width:80px;height:auto;">
                           </td>
                            <td>{{$val->name}}</td>
                            <td>{{$val->code}}</td>
                            <td>{{$val->title}}</td>
                           ...
                           <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <a title="Edit" class="btn btn-sm btn-secondary" style="color: black" href="{{ route('products.edit', $val->id)}}"><i class="fa fa-edit">Edit</i></a>
                                    </li>

                                      <li>
                                        <a title="Details" class="btn btn-sm btn-secondary" style="color: black" href="{{ route('product-detail', $val->id)}}"><i class="fa fa-bars">Details</i></a>
                                    </li>
                                    <li>
                                        <a title="Delete" class="btn btn-sm btn-danger" href="{{ route('products.delete',$val->id)}}"><i class="dripicons-trash">Delete</i></a>
                                    </li>


                                 <!--    <li>
                                        <a target="_blank" title="view" class="btn btn-sm btn-primary" style="color: black" href=""><i class="fa fa-eye">view</i></a>
                                    </li> -->

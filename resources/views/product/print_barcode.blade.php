            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('get-product-barcode')}}" method="POST">
                            @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <strong style="display:none;"><input type="checkbox" name="promo_price"/> {{trans('file.Promotional Price')}}</strong>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
    ...
    select: function(event, ui) {
        ...
        $.ajax({
            ...
            success: function(data) {
              ...
              $("input[name='product_code_name']").val(data[1]);
                if(flag){
                    ...
                    var cols = '';
                    cols += '<td>' + data[0] + '</td>';
                    cols += '<td class="product-code"><input type="hidden" class="form-control" name="product_code[]" value="' + data[1] + '" />' + data[1] + '</td>';

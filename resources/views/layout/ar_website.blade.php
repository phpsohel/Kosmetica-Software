                    ...
                    <select class="form-select currency_name" aria-label="Default select example"> 
                       ...
                       @endphp
                        @foreach($currencies as $currency)
                            <option value="{{$currency->id ?? ''}}" class="dropdown-item " >{{ $currency->name ?? '' }}</option>
                        @endforeach
                      </select>
                ...
                <div class="container">
                    ...
                    $quantity = App\Cart::where('user_ip', request()->ip())->where('session',$session)->sum('product_quantity');
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="{{ route('cart-page.ar') }}" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                                @if($quantity)
                                ...
                                <div class="dropdown-menu" style="left:0;right:auto;">
                                    <div class="dropdownmenu-wrapper">
                                            ...
                                            @foreach($carts as $row)
                                                ...
                                                <div class="product">
                                                    ...
                                                    <figure class="product-image-container">
                                                        ...
                                                        <a href="{{ route('cart-destroy-master.ar', $row->id) }}" class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                                    </figure>
                                                </div><!-- End .product -->
                                            @endforeach
                                        ...
                                        <div class="dropdown-cart-action">
                                            <a href="{{ route('cart-page.ar') }}" class="btn">عرض عربة التسوق</a>
                    ...
                    <div class="header-center">
                        <a href="{{ url('http://223.27.94.123/kosmetica/eshop/ar' )}}" class="logo">
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-search">
                            ...
                            <form action="{{ route('search.ar') }}" method="post">
                                @csrf
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                              @for( $i=0; $i< count($make_up);$i++)
                                                    ...
                                                    @endphp
                                                <div class="col-lg-3">
                                                    <div class=""><a href="{{ route('category-product_name.ar', ['id' => $make_up[$i]->id, 'name' => $name ]) }}">{{ $make_up[$i]->name_ar }}</a>
                                                    </div>
                                                </div><!-- End .col-lg-6 -->
                                               @endfor
                                            </div><!-- End .row -->
                                        ...
                                        <li><a href="#">العناية بالجسم</a>
                                            <ul>
                                                @for( $i=0; $i< count($body_care_cat);$i++)
                                                    ...
                                                    @endphp
                                                <li><a href="{{ route('category-product_name.ar',['id' => $body_care_cat[$i]->id, 'name' => $name ]) }}">{{ $body_care_cat[$i]->name_ar }}</a></li>
                                                @endfor
                                            </ul>
                                        </li>
                                        <li><a href="#">العناية بالشعر</a>
                                            <ul>
                                                @for( $i=0; $i< count($hair_care_cat);$i++)
                                                    ...
                                                    @endphp
                                                <li><a href="{{ route('category-product_name.ar',['id' => $hair_care_cat[$i]->id, 'name' => $name ]) }}">{{ $hair_care_cat[$i]->name_ar }}</a></li>
                                                @endfor
                                            </ul>
                                        </li>
                                        <li><a href="#">العناية بفروة الرأس</a>
                                            <ul>
                                                @for( $i=0; $i< count($scalp_care_cat);$i++)
                                                    ...
                                                    @endphp
                                                    <li><a href="{{route('category-product__name_hair_scalp.ar',['id' => $scalp_care_cat[$i]->id, 'name' => $name ]) }}">{{ $scalp_care_cat[$i]->name_ar }}</a></li>
                                                @endfor
                                            </ul>
                                        </li>
                                </ul>
                                    ...
                                    <li><a href="#">نمط</a>
                                        <ul>
                                            @for( $i=0; $i< count($routines);$i++)
                                                ...
                                                @endphp
                                                <li><a href="{{ route('tag-product_name.ar',['id' => $routines[$i]->id, 'name' => $name ]) }}">{{ $routines[$i]->tag_name_ar }}</a></li>
                                            @endfor
                                        </ul>
                                    </li>
                                    <li><a href="#">مكونات</a>
                                        <ul>
                                            @for( $i=0; $i< count($ingredients);$i++)
                                                ...
                                                @endphp
                                                <li><a href="{{ route('tag-product_name.ar',['id' => $ingredients[$i]->id, 'name' => $name ]) }}">{{ $ingredients[$i]->tag_name_ar }}</a></li>
                                            @endfor
                                        </ul>
                                    </li>
                                    <li><a href="#">مشكلة الجلد</a>
                                        <ul>
                                            @for( $i=0; $i< count($skin_issues);$i++)
                                                ...
                                                @endphp
                                                <li><a href="{{ route('tag-product_name.ar',['id' => $skin_issues[$i]->id, 'name' => $name ]) }}">{{ $skin_issues[$i]->tag_name_ar }}</a></li>
                                            @endfor
                                        </ul>
                                    </li>
                                </ul>
                                            ...
                                            <div class="row">
                                              ...
                                              @for( $i=0; $i< count($brands);$i++)
                                               ...
                                               @php if($i!=0 && $i%5==0){ echo '</div><div class="col-lg-3">';} @endphp
                                                    <div class=""><a href="{{ route('brands-product_name.ar',['id' => $brands[$i]->id, 'name' => $name ]) }}">{{ $brands[$i]->title_ar }}</a>
                                                    </div>
                                                 <!-- End .col-lg-6 -->
                                               @endfor
                                               <div style="padding: 0px 5px; background: #cb253f;"><a href="{{ route('brands-product-other.ar') }}" style="color:white;"> آحرون >> </a>
                                                    </div>
                                            </div><!-- End .row -->
                                        </div><!-- End .col-lg-8 -->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <ul class="links">
                                            ...
                                            @if(!Auth::check())
                                            <li><a href="{{ route('eshop-login.ar') }}">تسجيل الدخول</a></li>
                                            @endif

                                             @if(Auth::check())
                                                <li><a href="{{ route('eshop-profile') }}">حسابي</a></li>
                                             @else
                                                <li><a href="{{ route('eshop-login.ar') }}">حسابي</a></li>
                                             @endif

                                            @if(Auth::check())
                                                <li><a href="{{ route('orders') }}">تاريخ الطلبات</a></li>
                                            @else
                                                <li><a href="{{ route('eshop-login.ar') }}">تاريخ الطلبات</a></li>
                                            @endif

                                            @if(Auth::check())
                                                <li><a href="{{ route('my_wishlist.ar') }}">قائمة الرغبات</a></li>
                                            @else
                                                <li><a href="{{ route('eshop-login.ar') }}">قائمة الرغبات</a></li>
                                            @endif
                                    ...
                                    <div class="col-sm-12">
                                        <ul class="links">
                                             @foreach($brands as $key)
                                                    <li><a href="{{ route('brands-product.ar', $key->id) }}">{{ $key->title_ar }}</a></li>
                                            @endforeach
                                        </ul>
                                    </div><!-- End .col-sm-6 -->
                                </div><!-- End .row -->
                                    ...
                                    <div class="col-sm-12">
                                        <ul class="links">
                                           @foreach($parent_makeup as $row)
                                               <li> <a href="{{ route('all-categories.ar', $row->id) }}">{{ $row->name_ar }}</a></li>
                                              @endforeach
                                        </ul>
                                    </div><!-- End .col-sm-6 -->
                                </div><!-- End .row -->
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                                        ...
                                        <div class="col-lg-6">
                                            <ul>
                                                @for( $i=0; $i< count($mobile_brands);$i++)
                                                    <li> <a href="{{ route('brands-product.ar', $mobile_brands[$i]->id) }}">{{ $mobile_brands[$i]->title }}</a></li>
                                                @endfor
                                                <li> <a href="{{ route('brands-product-other.ar') }}">الآخرين >> </a></li>
                                            </ul>
                                        </div><!-- End .col-lg-6 -->
                            </div>
                        </div><!-- End .megamenu -->
                    ...
                    <li class="{{ (request()->segment(2) == 'category-product') ? 'active' : '' }}">
                        ...
                        <ul>
                            <li><a href="#">نمط</a>
                                ...
                                <ul>
                                    @for( $i=0; $i< count($routines);$i++)
                                        <li><a href="{{route('tag-product.ar', $routines[$i]->id) }}">{{ $routines[$i]->tag_name }}</a></li>
                                    @endfor
                                </ul>
                            </li>
                            <li><a href="#">مكونات</a>
                                ...
                                <ul>
                                    @for( $i=0; $i< count($ingredients);$i++)
                                        <li><a href="{{route('tag-product.ar', $ingredients[$i]->id) }}">{{ $ingredients[$i]->tag_name }}</a></li>
                                    @endfor
                                </ul>
                            </li>
                            <li><a href="#">مشكلة الجلد</a>
                                <ul>
                                    @for( $i=0; $i< count($skin_issues);$i++)
                                        <li><a href="{{route('tag-product.ar', $skin_issues[$i]->id) }}">{{ $skin_issues[$i]->tag_name }}</a></li>
                                    @endfor
                                </ul>
                            </li>
                        </ul>
                                ...
                                <div class="col-lg-6">
                                    <ul>
                                        <li><a href="#">العناية بالجسم</a>
                                            <ul>
                                                @for( $i=0; $i< count($body_care_cat);$i++)
                                                <li><a href="{{route('category-product.ar', $body_care_cat[$i]->id) }}">{{ $body_care_cat[$i]->name }}</a></li>
                                                @endfor
                                            </ul>
                                        </li>
                                        <li><a href="#">العناية بالشعر</a>
                    ...
                    <li><a href="{{ route('eshop-mini-shop.ar') }}">متجر صغير</a></li>
                    <li><a href="{{ route('eshop-blogs.ar') }}">مقالات</a></li>
                    <li><a href="{{ route('right.now.ar') }}">بطاقة</a></li>
                    <li><a href="{{ route('contact.ar') }}">اتصل بنا</a></li>
                </ul>
            </nav><!-- End .mobile-nav -->
        ...
        <div class="modal-content">
          <div class="modal-body add-cart-box text-center">
            ...
            <div class="btn-actions">
                <a href="{{ route('cart-page.ar') }}"><button class="btn-primary">الذهاب إلى صفحة عربة التسوق</button></a>
                <a href="{{ route('eshop.ar') }}"><button class="btn-primary" data-dismiss="modal">يكمل</button></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content" >
          <div class="modal-body add-cart-box text-center">
            ...
            <div class="btn-actions">
                <a href="{{ route('eshop.ar') }}"><button class="btn-primary" data-dismiss="modal">Continue</button></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="max-width: 500px; margin: auto">
                <div class="modal-body add-cart-box text-center">
                    ...
                    <div class="btn-actions">
                        <a href="{{ route('eshop-login.ar') }}"><button class="btn-primary">تسجيل الدخول</button></a>
                        <a href="{{ route('eshop.ar') }}"><button class="btn-primary" data-dismiss="modal">يلغي</button></a>
                    </div>
                </div>
            </div>
        </div>

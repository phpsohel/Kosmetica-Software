        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb mt-0" style="float: right">
                    <li class="breadcrumb-item active" aria-current="page"> {{$category_name->name_ar}}</li>
                    <li class="breadcrumb-item"><a href="#">{{ $p_category_name->name_ar }}</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row row-sm">
                        @foreach($categories_product as $row)
                            @php
                                ...
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-action">
                                            ...
                                            <!--{{ Form::open(['route' => ['category-product.quick',$row->id], 'method' => 'POST'] ) }}-->
                                            <!--<div>-->
                                    ...
                                    <div class="featured-col">
                                        @foreach($next_products as $row)
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                                        <a href="{{ route('eshop-details.ar',['id' => $row->id, 'name' => $name ]) }}">{{ $row->name }}</a>
                                                    </h2>
                                                    @php
                                                        $full_rating = 0 ;
                                                        $rating = \App\Review::where('product_id',$row->id)->select('ratings')->get();

            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb"style="float: right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('all-categories.ar',$product->category_id) }}">{{ $cat_name->name_ar }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <div class="product-single-details">
                                        <p style='font-weight:bold;margin-bottom:0px;'><a href="{{ route('brands-product.ar', $product->brand_id) }}">{{ $brand_name->title_ar }}</a> </p>
                                        <span style="font-size: 20px;" class="product-title">{{ $product->name_ar }}</span>
                                        <br>
                                        @php
                                            $full_rating = 0 ;
                                        ...
                                        @if($product->type == 'combo' && $product->product_list != null && $product->qty_list !=null )
                                            @php
                                                $com_pro_id = explode(',',$product->product_list);
                                                $com_pro_qty = explode(',',$product->qty_list);
                                            @endphp

                                            @for ($i = 0; $i < count($com_pro_id); $i++)
                                                @php
                                            ...
                                            @if (in_array(null, $combo, true))
                                                <p> <bold>التوفر : </bold> <strong style="color: red"> Stock Unavailable</strong> @if($brand_name->notes != null)<strong style="color: red"> ({{$brand_name->notes}})</strong> @endif</p>

                                            @else
                                                <p>  <bold>التوفر : </bold><strong  style="color: #eb6006"> كمية محدودة</strong></p>
                                                <form action="{{ route('add-cart-quantity.ar', $product->id) }}" method="post">
                                                    @csrf
                                                    <div class="product-action product-all-icons">
                                                        ...
                                                        @if(Auth::user() == null)
                                                            <a href="{{ route('eshop-wishlist-login-check.ar', $product->id) }}" class=" paction add-wishlist btn-add-login icon-wish" title="أضف إلى قائمة الامنيات"></a>
                                                        @else
                                                            <a href="{{ route('eshop-wishlist.ar', $product->id) }}" class="paction add-wishlist icon-wish" title="أضف إلى قائمة الامنيات" ></a>
                                                        @endif
                                        ...
                                        @else
                                            ...
                                            @elseif($stock_available > 0 && $stock_available < 6 )
                                                <p>  <bold>التوفر : </bold><strong  style="color: #eb6006"> كمية محدودة</strong></p>
                                            @else
                                                <p> <bold>التوفر : </bold> <strong style="color: red"> مخزون متاح</strong> @if($brand_name->notes != null)<strong style="color: red"> ({{$brand_name->notes}})</strong> @endif</p>
                                            @endif
                                            ...
                                            <form action="{{ route('add-cart-quantity.ar', $product->id) }}" method="post">
                                                ...
                                                <div class="product-action product-all-icons">
                                                    ...
                                                    @if(Auth::user() == null)
                                                        <a href="{{ route('eshop-wishlist-login-check.ar', $product->id) }}" class=" paction add-wishlist btn-add-login icon-wish" title="Add to Wishlist"></a>
                                                    @else
                                                        <a href="{{ route('eshop-wishlist.ar', $product->id) }}" class="paction add-wishlist icon-wish" title="Add to Wishlist" ></a>
                                                    @endif
                                                </div><!-- End .product-action -->
                                            </form>
                                    ...
                                    <div class="product-single-tabs">
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="product-tab-reviews" data-toggle="tab" href="#product-reviews-content" role="tab" aria-controls="product-reviews-content" aria-selected="false">المراجعات( {{ count($comments) }})</a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <strong>{{$comment->customer->name}}</strong>
                                                        ...
                                                        <div class="add-product-review">
                                                            ...
                                                            @if(Auth::user() == null)
                                                                ...
                                                                <br>
                                                                <a href="{{ route('eshop-login.ar') }}"><button class=" btn btn-primary">تسجيل الدخول</button></a>
                                                            @else
                            ...
                            <div class="product-single-details">
                                ...
                                <form action="{{ route('add-to-cart.ar', $product_details_info->id) }}" method="POST">
                                    ...
                                    <div class="product-action">
                                        ...
                                        @if(Auth::user() == null)
                                            <a href="{{ route('eshop-wishlist-login-check.ar', $product_details_info->id) }}" class="paction add-wishlist" title="أضف إلى قائمة الامنيات">

                                            </a>
                                        @else
                                            <a href="{{ route('eshop-wishlist.ar', $product_details_info->id) }}" class="paction add-wishlist" title="أضف إلى قائمة الامنيات" ></a>
                                        @endif
                                    </div><!-- End .product-action -->
                                </form>

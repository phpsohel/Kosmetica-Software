        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb mt-0">
                    <li class="breadcrumb-item"><a href="{{ route('http://223.27.94.123/kosmetica/eshop/ar') }}"><i class="icon-home"></i></a></li>
                    <li class="breadcrumb-item"><a href="{{ route('tag.product.ar', $tag->id) }}">{{$tag->tag_name_ar}}</a></li>
                </ol>
            </div><!-- End .container -->
        </nav>
        <div class="container">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row row-sm">
                        @if($tags_product->count() > 0)
                                    ...
                                    <div class="product-default">
                                        ...
                                        <div class="product-details">
                                            <div class="price-box" style="display: inline-flex;margin-bottom: 5px;">
                                                <img src="{{ url('public/images/brand', $brands[0]->image) }}" alt="product" style="height: 20px; width: auto;">
                                            ...
                                            <form action="{{ route('eshop-detail.ar', $row->id) }}" method="get">
                                                @csrf
                                                <div class="product-action">
                                                    <a href="#" class="btn-icon-wish"><i class="icon-heart"></i></a>
                                                    <button type="submit" class="btn-icon btn-add-cart"><i class="icon-bag"></i>أضف إلى السلة</button>
                                                    <input type="hidden" name="product_price" value="{{ $row->price}}">
                                                    <a href="{{ route('eshop-detail.ar', $row->id) }}" class="btn-quickview" title="Quick View"><i class="fas fa-external-link-alt"></i></a>
                                                </div>
                                            </form>
                            ...
                            @endforeach
                        @else
                            <h1> لم يتم العثور على أي منتج!</h1>
                        @endif
                    </div>
                    ...
                    <div class="sidebar-wrapper">
                        <div class="widget">
                            <h3 class="widget-title">
                                <a data-toggle="collapse" href="#widget-body-2" role="button" aria-expanded="true" aria-controls="widget-body-2">سعر</a>
                            </h3>
                        ...
                        <div class="widget widget-featured">
                            <h3 class="widget-title">منتجات مميزة</h3>
                                    ...
                                    <div class="featured-col">
                                        @foreach($products as $row)
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                                        <a href="{{ route('eshop-detail.ar', $row->id) }}">{{ $row->name_ar }}</a>
                                                    </h2>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span><!-- End .ratings -->

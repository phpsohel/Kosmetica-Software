			...
			<div class="row order_d_inner">
				<div class="col-lg-4" style="border: 1px solid #d0cfcf; border-radius: 10px; padding: 20px; margin: 2px;">
					<div class="details_item"><br><br>
						...
						<ul class="list">
							<li>
							<span><strong> Reference</strong></span>  : {{ $sale->reference_no }}
							</li>
							<li>
							<span><strong> Date</strong></span>  : {{ date('d-m-Y', strtotime($sale->created_at)) }}
							</li>
							<li>
								<span><strong>Total</strong></span> : ৳ {{ $sale->grand_total }}
							</li>
							<li>
								<span><strong>Shop</strong></span> :  {{ $sale->warehouse->name }}
							</li>

							@if($payment)
							 <li>
							    <span><strong> Payment method</strong></span> : {{$payment->paying_method}}
							</li>
							@endif
						</ul>
					</div>

                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          @if($recent_purchase)
                            ...
                            <tr>
                              <td>{{date($general_setting->date_format, strtotime($purchase->created_at)) }}</td>

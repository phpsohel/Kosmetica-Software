            ...
            <tbody>
                ...
                <tr data-id="{{$brand->id}}">
                    ...
                    @if($brand->parent_id != null)
                        @php
                            $parent_brand = \App\Brand::where('id',$brand->parent_id)->first();
                        @endphp
                    <td>{{ $parent_brand->title }}</td>
                    @else
                     <td>N/A</td>
                    @endif
                    <td>{{ $brand->notes }}</td>
          ...
          <div class="row">
            <div class="col-md-6 form-group">
              ...
              <div class="col-md-6 form-group">
                ...
                {{Form::text('title_ar',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type brand title...'))}}
            </div>
            <div class="col-md-6 form-group">
                <label>Image</label>
            ...
            <div class="col-md-6 form-group">
                ...
                {{Form::select('parent_id', $lims_brands, null, ['class' => 'form-control','placeholder' => 'No Parent Brand'])}}
            </div>

              <div class="col-md-6 form-group">
                  <label>Notes</label>
                  {{Form::text('notes',null,array('class' => 'form-control', 'placeholder' => 'Type notes...'))}}
              </div>
          </div>
        ...
        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
          ...
          <div class="col-md-6 form-group">
            ...
            {{Form::text('title',null, array('required' => 'required', 'class' => 'form-control'))}}
              ...
              <div class="col-md-6 form-group">
            <label>Title(ar) *</label>
            {{Form::text('title_ar',null, array('required' => 'required', 'class' => 'form-control'))}}
        </div>

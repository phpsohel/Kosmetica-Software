                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        $check_w_product  =  \App\Product_Warehouse::where('product_id',$product_quotation->product_id)->where('warehouse_id',$lims_quotation_data->warehouse_id)->where('qty','>',0)->first();
                                                    ...
                                                    ?>
                                                       @if($check_w_product == null)
                                                        <td><strong style="color: red">{{$product_data->name}}</strong>   <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button><br> (Available qty :<strong style="color: red"> 0 </strong> ) </td>
                                                        @else
                                                            <td>{{$product_data->name}}<button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button> <br> (Available qty : {{$check_w_product->qty}} ) </td>
                                                       @endif

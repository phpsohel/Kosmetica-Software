                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    @endphp
                                      ...
                                      @if($role->hasPermissionTo('date'))

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="d-block">{{trans('file.Date')}} *</label>
                                            <input class=" form-control w-100" type="date" name="created_at" value="{{$date}}">
                                        </div>
                                    </div>
                                      @endif

                                    <input class="" type="hidden" name="quotation_id">

                                    <div class="col-md-4">
                                        <div class="input-group pos">
                                            <label class="d-block">{{trans('file.customer')}} *</label>
                                            <select required name="customer_id" id="customer_id" class="selectpicker form-control" data-live-search="true"  title="Select customer...">
                                                ...
                                                <option  value="{{$customer->id}}">{{$customer->phone_number . ' (' . $customer->name . ')'}}</option>
                                                    {{--<button type="button" data-id="{{$customer->id}}" class="btn btn-default btn-sm" data-toggle="modal" data-target="#viewCustomer"><i class="dripicons-view-apps"></i> view</button>--}}
                                                    @endforeach
                                            </select>
                                            {{--<button type="button" data-id="{{$customer->id}}" class="deposit btn btn-link" data-toggle="modal" data-target="#depositModal" ><i class="dripicons-view-apps"></i></button>--}}
                                            {{--<button type="button" data-id="{{$customer->id}}" class="btn btn-default btn-sm" data-toggle="modal" data-target="#viewCustomer"><i class="dripicons-view-apps"></i> view</button>--}}
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="discount_value" name="order_discount" class="form-control" step="any"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div id="payment">
                                    <div class="row">
                                        ...
                                        <div style="display: none" class="col-md-6 mt-1 ischange">
                                            <label></label>
                                            <input type="hidden"  class="form-control" name="other_payment">
                                        </div>
...
$('select[name="customer_id"]').on('change', function() {
    var id = $(this).val();
    $.get('getcustomeraddress/' + id, function(data) {
        if (data) {
            $("div.viewAddress").html(data)
        }
...
function calculateGrandTotal() {
    ...
    $('#discount_value').val(order_discount.toFixed(2));

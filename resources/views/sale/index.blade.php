                        ...
                        @endphp
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class=" form-control w-100" type="date" required name="payment_date" value="{{$date}}">
                                </div>
                            </div>
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'sale.update-payment', 'method' => 'post', 'class' => 'payment-form' ]) !!}
                    <div class="row">
                        <div class="col-md-6">
                            <label>Date *</label>
                            <input type="date" name="payment_date" class="form-control numkey"  step="any" required>
                        </div>
                        <div class="col-md-6">
                            <label>{{trans('file.Recieved Amount')}} *</label>
    ...
    $("table.payment-list").on("click", ".edit-btn", function(event) {
        ...
        $.each(payment_id, function(index){
            if(payment_id[index] == parseFloat(id)){
                ...
                $('input[name="payment_date"]').val(payment_date[index]);

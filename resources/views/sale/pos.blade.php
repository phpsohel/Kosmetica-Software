                ...
                <div class="card">
                    ...
                    <div class="payment-options">
                      <!--   <div class="column-5">
                        ...
                        <div class="column-5">
                            <button style="background-color: #fd7272" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="bkash-btn"><i class="fa fa-money"></i> Bkash</button>
                        </div>
                      <!--   <div class="column-5">
                            <button style="background-color: #213170" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="paypal-btn"><i class="fa fa-paypal"></i> Card</button>
                        </div> -->
                        <div class="column-5">
                            <button style="background-color: #e28d02" type="button" class="btn btn-custom" id="draft-btn"><i class="dripicons-flag"></i> Draft</button>
                        </div>
                        <div class="column-5">
                            <button style="background-color: #fd7272" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cheque-btn"><i class="fa fa-money"></i> Credit Card</button>
                        </div>
                        {{--<div class="column-5">--}}
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12 cheque">
                                            ...
                                            <input type="text" name="cheque_no" value="Card number" class="form-control">
                                        </div>

                                        <div class="form-group col-md-12 bkash">
                                            <label>Mobile No/ Transaction No *</label>
                                            <input type="text" name="mobile_transaction" value="Mobile/Transaction No" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-1 ischange">
                                            <label>{{trans('Remaining Amount')}} *</label>
                                            <input type="text"  class="form-control numkey" name="other_payment" required step="any">
                                        </div>

                                        <div class="col-md-6 mt-1 ischange">
                                            <input type="hidden" name="paid_by_id2">
                                            <label>{{trans('file.Paid By')}}</label>
                                            <select name="paid_by_id_select2" class="form-control selectpicker">
                                                <option value="1">Cash</option>
                                                <option value="7">Bkash</option>
                                                {{--<option value="2">Gift Card</option>--}}
                                                <option value="4">Credit Card</option>
                                        ...
                                        {{--<div class="form-group col-md-12 gift-card2">--}}
                                            {{--<label> {{trans('file.Gift Card')}} *</label>--}}
                                            {{--<input type="hidden" name="gift_card_id">--}}
                                            {{--<select id="gift_card_id_select" name="gift_card_id_select" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Gift Card..."></select>--}}
                                        {{--</div>--}}
                                        {{--<div class="form-group col-md-12 cheque2">--}}
                                            {{--<label>{{trans('Card Number')}} *</label>--}}
                                            {{--<input type="text" name="cheque_no" value="Card number" class="form-control">--}}
                                        {{--</div>--}}

                                        {{--<div class="form-group col-md-12 bkash2">--}}
                                            {{--<label>Mobile No/ Transaction No *</label>--}}
                                            {{--<input type="text" name="mobile_transaction" value="Mobile/Transaction No" class="form-control">--}}
                                        {{--</div>--}}
                            ...
                            <div class="col-md-12">
                                <table class="table table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Bkash Payment :</td>
                                            <td id="bkash_payment" class="text-right"></td>
                                        </tr>
                                        <tr>
  ...
  $("#register-details-btn").on("click", function (e) {
      ...
      $.ajax({
          ...
          success:function(data) {
              ...
              $('#register-details-modal #bkash_payment').text(data['bkash_payment']);
  ...
  $("#today-sale-btn").on("click", function (e) {
      ...
      $.ajax({
          ...
          success:function(data) {
              ...
              $('#today-sale-modal .bkash_payment').text(data['bkash_payment']);
...
$('button[name="update_btn"]').on("click", function() {
    var edit_discount = $('input[name="edit_discount"]').val();
      var result = edit_discount.includes("%");
    ...
    var testme=$('input[name="edit_discount"]').val();
    result = testme.includes("%");
    if(result==true){
        var result= testme.split("%");
        var final = (result[0] /100) * edit_unit_price;
        product_discount[rowindex] = final;
    }
    else{
...
$("#deposit-btn").on("click",function() {
    ...
    $("#gift-card-btn").on("click",function() {
        $('select[name="paid_by_id_select2"]').val(2);
        $('.selectpicker').selectpicker('refresh');
        $('div.qc').hide();
        giftCard2();
    });
    ...
    $("#credit-card-btn").on("click",function() {
        $('select[name="paid_by_id_select2"]').val(3);
        $('.selectpicker').selectpicker('refresh');
        $('div.qc').hide();
        creditCard();
    });
    ...
    $("#cheque-btn").on("click",function() {
        $('select[name="paid_by_id_select2"]').val(4);
        $('.selectpicker').selectpicker('refresh');
        $('div.qc').hide();
        cheque2();
    });
    ...
    $("#bkash-btn").on("click",function() {
        $('select[name="paid_by_id_select2"]').val(7);
        $('.selectpicker').selectpicker('refresh');
        $('div.qc').hide();
        bkash2();
    });
    ...
    $("#cash-btn").on("click",function() {
        $('select[name="paid_by_id_select2"]').val(1);
        $('.selectpicker').selectpicker('refresh');
        $('div.qc').show();
        hide2();
    });
    ...
    $("#paypal-btn").on("click",function() {
        $('select[name="paid_by_id_select2"]').val(5);
        $('.selectpicker').selectpicker('refresh');
        $('div.qc').hide();
        hide2();
    });
    ...
    $("#deposit-btn").on("click",function() {
        $('select[name="paid_by_id_select2"]').val(6);
        $('.selectpicker').selectpicker('refresh');
        $('div.qc').hide();
        hide2();
        deposits();
...
$('select[name="paid_by_id_select2"]').on("change", function() {
    var id = $(this).val();
    $(".payment-form").off("submit");
    if(id == 2) {
        $('div.qc').hide();
...
function change(paying_amount, paid_amount) {
   ...
   if((parseFloat(paying_amount - paid_amount).toFixed(2)) <= 0.00 ){
      $('.ischange').hide();
   }else{
       $('.ischange').show();
       $('input[name="other_payment"]').val(parseFloat(paying_amount - paid_amount).toFixed(2));
   }
...
function addNewProduct(data){
    ...
    cols += '<td class="col-sm-4 product-title" style="overflow:hidden;"><button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal" title="' + data[0] + '"><strong>' + data[0] + '</strong></button> [' + data[1] + '] <p>In Stock: <span class="in-stock"></span></p></td>';
    ...
    // if(data[11]!= null && product_warehouse_price[pos]) {
...
function calculateGrandTotal() {
    ...
    var order_discnt = $('input[name="order_discount"]').val();
    if(order_discnt.search("%")!=-1 ){
        var discount_percent = parseFloat(order_discnt);
        var discount_amount = ((discount_percent*subtotal)/100);
         order_discount = parseFloat(discount_amount);

    }
    else {
         order_discount = parseFloat(order_discnt);
...
$(document).on('submit', '.payment-form', function(e) {
    ...
    $('input[name="paid_by_id2"]').val($('select[name="paid_by_id_select2"]').val());

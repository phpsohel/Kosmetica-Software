...
<div style="max-width:400px;margin:0 auto">
   ...
   <p>{{trans('file.Date')}}: {{$lims_sale_data->created_at->format('d/m/Y')}}<br>
            ...
            <tbody>
                ...
                <?php
                   ...
                   // dd($lims_product_data);
                    $brand = \App\Brand::where('id',$lims_product_data->brand_id)->first();
                    $final_price = $product_sale_data->total / $product_sale_data->qty;
                ...
                ?>
                <tr>
                    @if($lims_product_data->price != $final_price)
                        <td colspan="2">
                            {{$brand->title}} - {{$product_name}}
                            <br>{{$product_sale_data->qty}} x {{number_format((float)($product_sale_data->total / $product_sale_data->qty), 2, '.', '')}}   <span style="font-size: 11px;">(Original Price: {{ $lims_product_data->price }})  </span>

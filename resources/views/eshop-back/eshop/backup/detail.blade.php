                                ...
                                <div class="col-lg-5 col-md-6">
                                    <div class="product-single-details">
                                        ...
                                        <div class="product-single-share">
                                            <label>Category :   <strong> {{ $cat_name->name}}</strong> </label>
                                        ...
                                        <div class="product-single-share">
                                            <label>Tag:
                                                @foreach($tags as $tag)
                                               <li><a href="{{ route('tag.product', $tag->id) }}"><strong> {{ $tag->tag_name}}</strong></a></li>
                                              @endforeach
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="product-stock-content" role="tabpanel" aria-labelledby="product-tab-reviews">
                                    <div class="product-stock-content">
                                        <table style="width: 90%;" class="ratings-table">
                                            <thead>
                                            <tr>
                                                <th>Shop Name</th>
                        ...
                        <div class="sidebar-wrapper">
                            ...
                            <div class="widget widget-brand">
                                {{--<a href="{{ route('brands-product', $product->brand_id) }}">--}}
                                    {{--<img style="max-height: 75px;width: auto;" src="{{ url('public/images/brand', $brand_name->image) }}">--}}
                                {{--</a>--}}
                                <h4>{{ $brand_name->title }} </h4>
                            </div><!-- End .widget -->
                            @endif

                                    ...
                                    @foreach($carts as $row)
                                        ...
                                        <td class="product-col">
                                            <figure class="product-image-container">
                                                <a href="{{ route('eshop-detail', $row->product->id) }}" class="product-image">
                                                    <img src="{{ url('public/images/product', $first_image) }}" style="height: 150px; width: auto;" alt="product">
                                                </a>
                                            </figure>
                                            <h5  class="product-title">
                                                <a  href="{{ route('eshop-detail', $row->product->id) }}">{{ $row->product->name }}</a>
                                            </h5>
                                        </td>
                            ...
                            <div class="collapse" id="total-estimate-section">
                                <form action="{{ route('checkout', request()->ip()) }}" id="shippingCheck" method="POST">
                                    ...
                                    <div class="form-group form-group-custom-control ">
                                          <input type="radio" id="inside" name="shipping_cost" value="60">

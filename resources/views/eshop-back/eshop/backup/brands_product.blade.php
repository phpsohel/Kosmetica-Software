...
@section('home_content')
  ...
  <main class="main">
            <div class="banner banner-cat" style="background-image: url('{{ asset('/') }}public/assets/frontend/images/sliderbackground.png');  height: 450px;">
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                                <div class="product-default">
                                   ...
                                   {{--<form action="{{ route('add-cart-quantity', $row->id) }}" method="POST">--}}
                                    {{--@csrf--}}
                                            {{--<div class="product-action">--}}

                                                {{--@if(Auth::user() == null)--}}
                                                    {{--<a href="{{ route('eshop-wishlist-login-check', $row->id) }}" class="btn-icon-wish" title="Add to Wishlist" ><i class="icon-heart"></i></a>--}}
                                                {{--@else--}}
                                                    {{--<a href="{{ route('eshop-wishlist', $row->id) }}" class="btn-icon-wish" title="Add to Wishlist" ><i class="icon-heart"></i></a>--}}
                                                {{--@endif--}}
                                                    {{--@if($row->qty > 0 )--}}

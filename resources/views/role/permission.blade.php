						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("brand-product-report", $all_permission))
														<input type="checkbox" value="1" id="brand-product-report" name="brand-product-report" checked>
													@else
														<input type="checkbox" value="1" id="brand-product-report" name="brand-product-report">
													@endif
													<label for="brand-product-report" class="padding05">Brand Product Report</label>
								                </div>
								            </div>
						                </span>
						                ...
						                <span>
								          ...
								          <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	@if(in_array("product-expiry-alert", $all_permission))
							                    	<input type="checkbox" value="1" id="product-expiry-alert" name="product-expiry-alert" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="product-expiry-alert" name="product-expiry-alert">
							                    	@endif
													<label for="product-expiry-alert" class="padding05">{{trans('Product Expiry Alert')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
								        </span>
						            ...
						            <td class="report-permissions" colspan="5">
						                ...
						                <span>
						                  ...
						                  <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
								                	@if(in_array("date", $all_permission))
							                    	<input type="checkbox" value="1" id="date" name="date" checked>
							                    	@else
							                   
							                    	<input type="checkbox" value="1" id="date" name="date">
							                    		@endif
							                    	
								                    <label for="date" class="padding05">Date &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
								                	@if(in_array("cost", $all_permission))
														<input type="checkbox" value="1" id="cost" name="cost" checked>
													@else

														<input type="checkbox" value="1" id="cost" name="cost">
													@endif

													<label for="cost" class="padding05">View Product Cost &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("stock_list", $all_permission))
														<input type="checkbox" value="1" id="stock_list" name="stock_list" checked>
													@else
														<input type="checkbox" value="1" id="stock_list" name="stock_list">
													@endif
													<label for="stock_list" class="padding05">Stock list</label>
								                </div>
								            </div>
						                </span>
						                <span>

                                ...
                                <div class="row">
                                    ...
                                    @php
                                      $role = Spatie\Permission\Models\Role::find(Auth::user()->role_id);
                                       ...
                                       $notself_lims_warehouse_list = \App\Warehouse::where('is_active', true)->where('id','!=',$warehouse_id)->get();
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class=" form-control w-100" type="date" name="created_at">
                                        </div>
                                    </div>
                                      @endif
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="to_warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select warehouse...">
                                                @foreach($notself_lims_warehouse_list as $warehouse)
                                                <option value="{{$warehouse->id}}">{{$warehouse->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th style="display: none;" id="total-tax">0.00</th>
                                                    <th  style="display: none;"id="total">0.00</th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<td style="display: none;" class="net_unit_cost"></td>';
                cols += '<td style="display: none;" class="tax"></td>';
                cols += '<td style="display: none;" class="sub-total"></td>';

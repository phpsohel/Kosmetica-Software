                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                         ...
                                         @php
                                        $date =  date('Y-m-d',strtotime($lims_transfer_data->created_at));
                                      @endphp

                                     <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="d-block">{{trans('file.Date')}} *</label>
                                            <input class=" form-control w-100" value="{{$date }}" type="date" name="created_at">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="display: none">{{trans('file.Net Unit Cost')}}</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td style="display: none" class="net_unit_cost">{{ number_format((float)$product_transfer->net_unit_cost, 2, '.', '') }} </td>
                                                        <td style="display: none"class="tax">{{ number_format((float)$product_transfer->tax, 2, '.', '') }}</td>
                                                        <td style="display: none" class="sub-total">{{ number_format((float)$product_transfer->total, 2, '.', '') }}</td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th style="display: none" id="total-tax">{{ number_format((float)$lims_transfer_data->total_tax, 2, '.', '')}}</th>
                                                    <th style="display: none" id="total">{{ number_format((float)$lims_transfer_data->total_cost, 2, '.', '')}}</th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>

@extends('layout.main') @section('content')
    ...
    <section class="forms">
        ...
        @php
        $brand_name = \App\Brand::where('id',$brand_id)->first();
        @endphp
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header mt-2">
                    @if($brand_id == 0)
                    <h3 class="text-center"> Brand Product Report</h3>
                     @else
                     <h3 class="text-center"> Product Report  ( Brand : {{$brand_name->title}} )</h3>
                    @endif
                </div>
                {!! Form::open(['route' => 'brand.product.wise', 'method' => 'post']) !!}
                <div class="row mb-3" style="margin-left: 10px;">
                    <div class="col-md-2">
                        <div class="form-group row">

                            <label class="d-tc mt-2"><strong>From</strong> &nbsp;</label>
                            <div class="d-tc">
                    ...
                    <div class="col-md-2" style="margin-left:30px;">
                        <div class="form-group row">
                            <label class="d-tc mt-2"><strong>To</strong> &nbsp;</label>
                            <div class="d-tc">
                                <div class="input-group">
                                    {{--<input type="text" class="daterangepicker-field form-control" value="{{$start_date}} To {{$end_date}}" required />--}}
                    ...
                    <div class="col-md-2">
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                <input type="hidden" name="brand_id_hidden" value="{{$brand_id}}" />

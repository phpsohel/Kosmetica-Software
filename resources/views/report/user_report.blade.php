...
<section class="forms">
    ...
    <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#user-log" role="tab" data-toggle="tab">Log</a>
        </li>
    </ul>
        ...
        <div role="tabpanel" class="tab-pane fade" id="user-log">
            <div class="table-responsive mb-4">
                <table id="payroll-table" class="table table-hover">
                    <thead>
                    <tr>
                        <th class="not-exported-payroll">SL</th>
                        <th>{{trans('file.Date')}}</th>
                        <th>{{trans('file.reference')}}</th>
                    </tr>
                    </thead>
                    ...
                    @foreach($lims_log_data as $key=>$log)
                        @php
                        ...
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>{{$log->datetime}}</td>
                            <td><strong>{{$log->referrence}}</strong> of amount BDT  <strong>{{$log->amount}}</strong> has been <strong>{{$log->action}}d</strong> by <strong>{{$user->name}}</strong>  </td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>

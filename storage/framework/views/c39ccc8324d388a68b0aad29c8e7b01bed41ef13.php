<?php $__env->startSection('home_content'); ?>
    <?php
    $p_category_name = \App\Category::where('id', $category_name->parent_id)->first();
    ?>
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb mt-0">
                    ...
                    <li class="breadcrumb-item"><a href="#"><?php echo e($p_category_name->name); ?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"> <?php echo e($category_name->name); ?></li>
                </ol>
            </div><!-- End .container -->
        </nav>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row row-sm">
                        ...
                        <?php $__currentLoopData = $categories_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-action">
                                            ...
                                            <!--<?php echo e(Form::open(['route' => ['category-product.quick',$row->id], 'method' => 'POST'] )); ?>-->
                                            <!--<div>-->
                                            <!--    -->
...
<?php echo $__env->make('layout.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kosmetica\resources\views/eshop/category_product.blade.php ENDPATH**/ ?>
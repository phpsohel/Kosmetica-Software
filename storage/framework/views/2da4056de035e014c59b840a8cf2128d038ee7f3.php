        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb mt-0">
                    ...
                    <li class="breadcrumb-item"><a href="#"><?php echo e($category_name->tag_parent_name); ?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"> <?php echo e($category_name->tag_name); ?></li>
                </ol>
            </div><!-- End .container -->
        </nav>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row row-sm">
                        <?php $__currentLoopData = $tags_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="price-box" style="display: inline-flex;margin-bottom: 5px;">
                                            ...
                                            <span class="product-title"> <?php echo e($category_name->name); ?></span>
                                        </div><!-- End .price-box -->
                                        ...
                                        <div class="price-box">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <span class="product-price">৳<?php echo e($row->promotion_price); ?></span>
                                            <?php endif; ?>
                                        </div><!-- End .price-box -->
                                        ...
                                        <!--<?php echo e(Form::open(['route' => ['category-hair-scalp-product.quick',$row->id], 'method' => 'POST'] )); ?>-->
                                            <!--<div>-->
                                        <!--    -->
                                        <!--    <input type="hidden" name="catg_id" value="<?php echo e($category_name->id); ?>">-->
                        ...
                        <div class="widget">
                            ...
                            <div class="collapse show" id="widget-body-2">
                                <div class="widget-body">
                                    ...
                                    <div class="row">
                                        <input type="hidden" name="brand_id" value="<?php echo e($category_name->id); ?>">
...
<?php echo $__env->make('layout.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kosmetica\resources\views/eshop/routine_skin_care.blade.php ENDPATH**/ ?>
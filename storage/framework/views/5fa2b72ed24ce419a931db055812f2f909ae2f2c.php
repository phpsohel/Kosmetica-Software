                    ...
                    <div class="tab-pane fade show active" id="skintype-category" role="tabpanel" aria-labelledby="featured-products-tab">
                        ...
                        <div class="product-default">
                                   ...
                                   <a class='prodata' data-id='<?php echo e($row->id); ?>' href="#tag_productlist">
                                    <img class="img-fluid rounded-circle mb-1" src="<?php echo e($row->image); ?>" alt="concern" style="max-width:150px;">
                                    <h4 style="text-align:center; color: #d1223e;"><?php echo e($row->tag_name); ?></h4>
                                </a>
                        </div>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kosmetica\resources\views/eshop/home.blade.php ENDPATH**/ ?>
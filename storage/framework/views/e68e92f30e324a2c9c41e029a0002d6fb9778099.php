                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="<?php echo e(route('eshop-details.ar',['id' => $row->product->id, 'name' => $name ])); ?>"><?php echo e($row->product->name); ?></a>
                                                </h4>
                ...
                <div class="container">
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            <li class="<?php echo e((request()->segment(2) == '') ? 'active' : ''); ?>"><a href="<?php echo e(route('eshop')); ?> "><i class="fa fa-home" aria-hidden="true"></i></a></li>
                             <li class="<?php echo e((request()->segment(2) == 'offer') ? 'active' : ''); ?>"><a href="<?php echo e(route('eshop-offer')); ?>"> Offers</a></li>
                            <li class="<?php echo e((request()->segment(2) == 'right') ? 'active' : ''); ?>"><a href="<?php echo e(route('right.now')); ?>">Right Now</a></li>
                                            ...
                                            <div class="row">
                                              ...
                                              <?php for( $i=0; $i< count($brands);$i++): ?>
                                               ...
                                               <?php if($i!=0 && $i%5==0){ echo '</div><div class="col-lg-3">';} ?>
                                                    <div class=""><a href="<?php echo e(route('brands-product_name',['id' => $brands[$i]->id, 'name' => $name ])); ?>"><?php echo e($brands[$i]->title); ?></a>
                                                    </div>

                                                 <!-- End .col-lg-6 -->
                                               <?php endfor; ?>
                                               <div style="padding: 0px 5px; background: #cb253f;"><a href="<?php echo e(route('brands-product-other')); ?>" style="color:white;"> Others >> </a>
                                                    </div>
                                        ...
                                        <li><a href="#">Body Care</a>
                                            ...
                                            <ul>
                                                <?php for( $i=0; $i< count($body_care_cat);$i++): ?>
                                                    ...
                                                    ?>
                                                <li><a href="<?php echo e(route('category-product_name',['id' => $body_care_cat[$i]->id, 'name' => $name ])); ?>"><?php echo e($body_care_cat[$i]->name); ?></a></li>
                                                <?php endfor; ?>
                                            </ul>
                                        </li>
                                        <li><a href="#">Hair Care</a>
                                            ...
                                            <ul>
                                                <?php for( $i=0; $i< count($hair_care_cat);$i++): ?>
                                                    ...
                                                    ?>
                                                <li><a href="<?php echo e(route('category-product_name',['id' => $hair_care_cat[$i]->id, 'name' => $name ])); ?>"><?php echo e($hair_care_cat[$i]->name); ?></a></li>
                                                <?php endfor; ?>
                                            </ul>
                                        </li>
                            ...
                            <li class="<?php echo e((request()->segment(2) == 'mini-shop') ? 'active' : ''); ?>"><a href="<?php echo e(route('eshop-mini-shop')); ?>">Mini Shop</a></li>
                            <li class="<?php echo e((request()->segment(2) == 'blogs') ? 'active' : ''); ?>"><a href="<?php echo e(route('eshop-blogs')); ?>">Blog</a></li>
                            <li class="float-right"><a href="<?php echo e(route('right.now')); ?>">Card</a></li>
                            <li class="<?php echo e((request()->segment(2) == 'contact') ? 'active' : ''); ?>"><a href="<?php echo e(route('contact')); ?>">Contact Us</a></li>
                        </ul>
                    </nav>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <ul class="contact-info">
                                            <li>
                                                <span class="contact-info-label">Address:</span><?php echo e($footer->address); ?>
                                    ...
                                    <div class="col-md-6">
                                        <ul class="contact-info">
                                            <li>
                                                <span class="contact-info-label">Phone:</span> <?php echo e($footer->phone); ?>

                                            </li>
                                            <li>
                                                <span class="contact-info-label">Email:</span> <?php echo e($footer->email); ?>
                                    ...
                                    <div class="col-sm-12">
                                        <ul class="links">
                                            ...
                                            <?php endif; ?>
                                             ...
                                             <?php else: ?>
                                                <li><a href="<?php echo e(route('eshop-login')); ?>">My Account</a></li>
                                             <?php endif; ?>

                                            <?php if(Auth::check()): ?>
                                                <li><a href="<?php echo e(route('orders')); ?>">Orders History</a></li>
                                            <?php else: ?>
                                                <li><a href="<?php echo e(route('eshop-login')); ?>">Orders History</a></li>
                                            <?php endif; ?>

                                            <?php if(Auth::check()): ?>
                                                <li><a href="<?php echo e(route('my_wishlist')); ?>">Wishlist</a></li>
                                            <?php else: ?>
                                                <li><a href="<?php echo e(route('eshop-login')); ?>">Wishlist</a></li>
                                            <?php endif; ?>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 text-center">
                            <p style="text-align: center;" class="footer-copyright"><?php echo e($footer->site_title); ?>. © <?php echo e($year); ?>. All Rights Reserved</p>
                        </div><!-- End .col-lg-5 -->
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    <li class="active"><a href="<?php echo e(route('eshop')); ?>">Home</a></li>
                     <li><a href="<?php echo e(route('eshop-offer')); ?>"> Offers</a></li>
                    <li><a href="<?php echo e(route('right.now')); ?>">Right Now</a></li>
                            ...
                            <div class="row">
                                        <div class="col-lg-6">
                                            <ul>
                                                ...
                                                <?php endfor; ?>
                                                <li> <a href="<?php echo e(route('brands-product-other')); ?>">OTHERS >> </a></li>
                                            </ul>
                                        </div><!-- End .col-lg-6 -->
                            </div>
                        </div><!-- End .megamenu -->
                    ...
                    <li><a href="<?php echo e(route('eshop-mini-shop')); ?>">Mini Shop</a></li>
                    <li><a href="<?php echo e(route('eshop-blogs')); ?>">Blog</a></li>
                    <li><a href="<?php echo e(route('right.now')); ?>">Card</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>">Contact Us</a></li>
                </ul>
            </nav><!-- End .mobile-nav -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="max-width: 500px; margin: auto">
                <div class="modal-body add-cart-box text-center">
                    ...
                    <div class="btn-actions">
                        <a href="<?php echo e(route('eshop-login')); ?>"><button class="btn-primary">Login</button></a>
                        <a href="<?php echo e(route('eshop')); ?>"><button class="btn-primary" data-dismiss="modal">Cancel</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="max-width: 500px; margin: auto">
                <div class="modal-body add-cart-box text-center" >
                    ...
                    <div class="btn-actions">
                        <a href="<?php echo e(route('eshop-profile')); ?>"><button class="btn-primary"> Wishlist</button></a>
                        <a href="<?php echo e(route('eshop')); ?>"><button class="btn-primary" data-dismiss="modal">Cancel</button></a>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\kosmetica\resources\views/layout/website.blade.php ENDPATH**/ ?>
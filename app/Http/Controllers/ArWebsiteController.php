...
class ArWebsiteController extends Controller
{
    //home page view
...
//    }
    ...
    public function contact()
    {
        ...
        return view('eshop.ar.contact', compact('brands','categories', 'carts', 'subtotal'));
    }
...
//                 ->get();
    ...
    public function offer()
    {
        ...
        return view('eshop.ar.offer', compact('quick_view','product_details_info','brands_product','categories', 'offer_products', 'carts', 'subtotal', 'brands', 'category_id', 'cat_name', 'cat', 'products', 'next_products'));
    }
    ...
    public function blogs()
    {
        ...
        return view('eshop.ar.blogs', compact('brands','categories', 'carts', 'subtotal', 'blogs', 'recent_blog'));
    }
    ...
    public function right_now()
    {
        ...
        $recent_blog = Blog::orderBy('id', 'DESC')
            ->limit(2)
            ->get();
        return view('eshop.ar.right-now', compact('brands','categories', 'carts', 'subtotal', 'blogs', 'recent_blog'));
    }

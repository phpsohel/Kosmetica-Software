...
class RoleController extends Controller
{
    ...
    public function setPermission(Request $request)
    {
        ...
        if($request->has('brand-product-report')){
            $permission = Permission::firstOrCreate(['name' => 'brand-product-report']);
            if(!$role->hasPermissionTo('brand-product-report')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('brand-product-report');
        ...
        if($request->has('product-qty-alert')){
            ...
            if($request->has('product-expiry-alert')){
            $permission = Permission::firstOrCreate(['name' => 'product-expiry-alert']);
            if(!$role->hasPermissionTo('product-expiry-alert')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('product-expiry-alert');
        ...
        if($request->has('hrm_setting')){
         ...
         $role->revokePermissionTo('hrm_setting');
          ...
          if($request->has('date')){
            $permission = Permission::firstOrCreate(['name' => 'date']);
            //dd($permission);
        ...
        if($request->has('cost')){
            $permission = Permission::firstOrCreate(['name' => 'cost']);
            //dd($permission);
            if(!$role->hasPermissionTo('cost')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('cost');
        ...
        if($request->has('stock_list')){
            $permission = Permission::firstOrCreate(['name' => 'stock_list']);
            if(!$role->hasPermissionTo('stock_list')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('stock_list');
